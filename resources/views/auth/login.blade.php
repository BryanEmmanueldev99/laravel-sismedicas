...
<div class="container">
  ...
  <div class="card card-outline card-primary shadow col-md-12">
    <div class="card-header text-center">
      ...
      <picture>
          <img class="img-fluid" width="100px" src="{{asset('dist/img/jesus_medico_logo.png')}}" alt="login">
      </picture>
    </div>
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('login') }}">
        @csrf
        <div class="row mb-3">
            <label for="email" class="col-md-12 col-form-label text-md-end">{{ __('Correo') }}</label>
